...
namespace Personel_Kayit
{
    public partial class FrmAnaForm : Form
    {
        ...
        private SqlConnection baglanti = new SqlConnection("Data Source=EVT03105NB;Initial Catalog=PersonelVeriTabani;Integrated Security=True");
        ...
        private void BtnKaydet_Click(object sender, EventArgs e)
        {
            ...
            komut.ExecuteNonQuery(); // (insert,update,delete kısmında kullanılır.)insert sorgusunu çalıştırır. Yazılmazsa hata vermez ama sorgunuzdaki işlemleri gerçekleştirmez.
            baglanti.Close();
